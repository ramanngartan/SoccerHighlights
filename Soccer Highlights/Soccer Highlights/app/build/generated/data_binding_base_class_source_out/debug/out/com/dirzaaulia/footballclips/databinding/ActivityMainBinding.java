...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView,
      @NonNull ViewToolbarBinding appBar, @NonNull BottomNavigationView bottomNav,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ViewToolbarBinding binding_appBar = ViewToolbarBinding.bind(appBar);
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, binding_appBar, bottomNav,
          navHostFragment);
    }
