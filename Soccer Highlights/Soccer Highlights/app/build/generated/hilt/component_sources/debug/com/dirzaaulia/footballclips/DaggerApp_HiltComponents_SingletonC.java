...
import com.dirzaaulia.footballclips.di.NetworkModule;
import com.dirzaaulia.footballclips.di.NetworkModule_ProvideScoreBatInterceptorClientFactory;
import com.dirzaaulia.footballclips.di.NetworkModule_ProvideScoreBatServiceFactory;
import com.dirzaaulia.footballclips.network.ScoreBatService;
import com.dirzaaulia.footballclips.repository.Repository;
import com.dirzaaulia.footballclips.ui.home.HomeFragment;
import com.dirzaaulia.footballclips.ui.home.HomeViewModel;
import com.dirzaaulia.footballclips.ui.home.HomeViewModel_HiltModules_KeyModule_ProvideFactory;
import com.dirzaaulia.footballclips.ui.main.MainActivity;
import com.dirzaaulia.footballclips.ui.viewer.ViewerFragment;
...
public final class DaggerApp_HiltComponents_SingletonC {
  ...
  private static final class FragmentCImpl extends App_HiltComponents.FragmentC {
    ...
    @Override
    public void injectViewerFragment(ViewerFragment arg0) {
    }
  ...
  private static final class ViewModelCImpl extends App_HiltComponents.ViewModelC {
    ...
    private Repository repository() {
      return new Repository(singletonCImpl.provideScoreBatServiceProvider.get());
    }
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, Provider<ViewModel>>singletonMap("com.dirzaaulia.footballclips.ui.home.HomeViewModel", ((Provider) homeViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.dirzaaulia.footballclips.ui.home.HomeViewModel 
          return (T) new HomeViewModel(viewModelCImpl.repository());
  ...
  private static final class SingletonCImpl extends App_HiltComponents.SingletonC {
    ...
    private Provider<OkHttpClient> provideScoreBatInterceptorClientProvider;

    private Provider<ScoreBatService> provideScoreBatServiceProvider;
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam,
      ...
      this.provideScoreBatInterceptorClientProvider = DoubleCheck.provider(new SwitchingProvider<OkHttpClient>(singletonCImpl, 1));
      this.provideScoreBatServiceProvider = DoubleCheck.provider(new SwitchingProvider<ScoreBatService>(singletonCImpl, 0));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.dirzaaulia.footballclips.network.ScoreBatService 
          return (T) NetworkModule_ProvideScoreBatServiceFactory.provideScoreBatService(singletonCImpl.networkModule, singletonCImpl.provideScoreBatInterceptorClientProvider.get());

          case 1: // okhttp3.OkHttpClient 
          return (T) NetworkModule_ProvideScoreBatInterceptorClientFactory.provideScoreBatInterceptorClient(singletonCImpl.networkModule, ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));
