...
public abstract class Hilt_ViewerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ViewerFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ViewerFragment_GeneratedInjector) this.generatedComponent()).injectViewerFragment(UnsafeCasts.<ViewerFragment>unsafeCast(this));
    }
  }
